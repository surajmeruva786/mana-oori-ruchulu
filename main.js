...
function initMap() {
    ...
    if (mapContainer && typeof L !== 'undefined') {
        // Create map centered at restaurant location
        const map = L.map('restaurant-map').setView([17.748087937756534, 83.26054048044244], 15);
        ...
        const restaurantMarker = L.marker([17.748087937756534, 83.26054048044244]).addTo(map);
        restaurantMarker.bindPopup("<b>Mana Oori Ruchulu</b><br>Bus Stop, beside Bank Of India, near Madhavadhara<br>Tenneti Nagar, Muralinagar, Visakhapatnam, Andhra Pradesh 530007").openPopup();
    }
}
